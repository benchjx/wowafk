    ...
    if (WinExist("ahk_class GxWindowClass")) {
      ...
      if (activeWindow = "World of Warcraft") {
        ...
        Loop, images/*.*
        {
          ...
          ImageSearch, X, Y, 0, 0, A_ScreenWidth, A_ScreenHeight, *5 images/%A_LoopFileFullPath%
        ...
        {
          ; imagesearch for same picture as needle
          ImageSearch, X, Y, 0, 0, A_ScreenWidth, A_ScreenHeight, *5 images/dc/%A_LoopFileFullPath%
